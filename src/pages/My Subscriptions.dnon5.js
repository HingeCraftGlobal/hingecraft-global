...
$w.onReady(function () {
    if (typeof document !== 'undefined') {
        // Page Title
        document.title = 'My Subscriptions | HingeCraft Global';
        ...
        metaDesc.setAttribute('content', 'My Subscriptions - HingeCraft Global. Comprehensive information, resources, and services.');
        ...
        // Open Graph Tags
        const ogTags = {
            'og:title': 'My Subscriptions | HingeCraft Global',
            'og:description': 'My Subscriptions - HingeCraft Global. Comprehensive information, resources, and services.',
            'og:image': 'https://hingecraft-global.ai/og-image.jpg',
            'og:url': 'https://hingecraft-global.ai/my-subscriptions',
            'og:type': 'website',
        ...
        const twitterTags = {
            ...
            'twitter:title': 'My Subscriptions | HingeCraft Global',
            'twitter:description': 'My Subscriptions - HingeCraft Global. Comprehensive information, resources, and services.',
        ...
        canonical.setAttribute('href', 'https://hingecraft-global.ai/my-subscriptions');
  ...
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "My Subscriptions | HingeCraft Global",
  "description": "My Subscriptions - HingeCraft Global. Comprehensive information, resources, and services.",
  "url": "https://hingecraft-global.ai/my-subscriptions",
  "publisher": {
    "@type": "Organization",
    "name": "HingeCraft Global",
...
$w.onReady(function () {
    if (typeof document !== 'undefined') {
        ...
        metaDesc.setAttribute('content', 'My Subscriptions - HingeCraft Global. Comprehensive information and resources.');
        ...
        const ogTags = {
            'og:title': 'My Subscriptions | HingeCraft Global',
            'og:description': 'My Subscriptions - HingeCraft Global. Comprehensive information and resources.',
            'og:image': 'https://hingecraft-global.ai/og-image.jpg',
            'og:url': 'https://hingecraft-global.ai/my-subscriptions',
            'og:type': 'website',
            'og:site_name': 'HingeCraft Global'
        ...
        const twitterTags = {
            'twitter:card': 'summary_large_image',
            'twitter:title': 'My Subscriptions | HingeCraft Global',
            'twitter:description': 'My Subscriptions - HingeCraft Global. Comprehensive information and resources.',
            'twitter:image': 'https://hingecraft-global.ai/og-image.jpg'
        };
  ...
  "@type": "WebPage",
  "name": "My Subscriptions | HingeCraft Global",
  "description": "My Subscriptions - HingeCraft Global. Comprehensive information and resources.",
  "url": "https://hingecraft-global.ai/my-subscriptions",
  "publisher": {
    "@type": "Organization",
    "name": "HingeCraft Global",
