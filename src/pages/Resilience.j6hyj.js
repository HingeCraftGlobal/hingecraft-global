...
$w.onReady(function () {
    if (typeof document !== 'undefined') {
        // Page Title
        document.title = 'Resilience | HingeCraft Global';
        ...
        metaDesc.setAttribute('content', 'Resilience - HingeCraft Global. Comprehensive information, resources, and services.');
        ...
        metaKeywords.setAttribute('content', 'resilience framework, community resilience, hingecraft, hingecraft global, resilient design');
        
        // Open Graph Tags
        const ogTags = {
            'og:title': 'Resilience | HingeCraft Global',
            'og:description': 'Resilience - HingeCraft Global. Comprehensive information, resources, and services.',
            'og:image': 'https://hingecraft-global.ai/og-image.jpg',
            'og:url': 'https://hingecraft-global.ai/resilience',
            'og:type': 'website',
        ...
        const twitterTags = {
            ...
            'twitter:title': 'Resilience | HingeCraft Global',
            'twitter:description': 'Resilience - HingeCraft Global. Comprehensive information, resources, and services.',
        ...
        canonical.setAttribute('href', 'https://hingecraft-global.ai/resilience');
  ...
  "@context": "https://schema.org",
  "@type": "WebPage",
  "name": "Resilience | HingeCraft Global",
  "description": "Resilience - HingeCraft Global. Comprehensive information, resources, and services.",
  "url": "https://hingecraft-global.ai/resilience",
  "publisher": {
    "@type": "Organization",
    "name": "HingeCraft Global",
  ...
  "inLanguage": "en-US",
  "keywords": "resilience framework, community resilience, hingecraft, hingecraft global, resilient design"
}`;
    }
...
$w.onReady(function () {
    if (typeof document !== 'undefined') {
        ...
        metaDesc.setAttribute('content', 'Resilience - HingeCraft Global. Comprehensive information and resources.');
        ...
        metaKeywords.setAttribute('content', 'resilience framework, community resilience, hingecraft, hingecraft global');
        
        // Open Graph Tags
        const ogTags = {
            'og:title': 'Resilience | HingeCraft Global',
            'og:description': 'Resilience - HingeCraft Global. Comprehensive information and resources.',
            'og:image': 'https://hingecraft-global.ai/og-image.jpg',
            'og:url': 'https://hingecraft-global.ai/resilience',
            'og:type': 'website',
            'og:site_name': 'HingeCraft Global'
        ...
        const twitterTags = {
            'twitter:card': 'summary_large_image',
            'twitter:title': 'Resilience | HingeCraft Global',
            'twitter:description': 'Resilience - HingeCraft Global. Comprehensive information and resources.',
            'twitter:image': 'https://hingecraft-global.ai/og-image.jpg'
        };
  ...
  "@type": "WebPage",
  "name": "Resilience | HingeCraft Global",
  "description": "Resilience - HingeCraft Global. Comprehensive information and resources.",
  "url": "https://hingecraft-global.ai/resilience",
  "publisher": {
    "@type": "Organization",
    "name": "HingeCraft Global",
  ...
  "dateModified": "2025-12-05",
  "inLanguage": "en-US",
  "keywords": "resilience framework, community resilience, hingecraft, hingecraft global"
}`;
    }
