...
function loadLegalPageContent() {
  ...
  <section class="hero-gradient text-white py-12 px-6">
    <div class="max-w-4xl mx-auto text-center">
      <h1 class="text-4xl font-bold mb-4">Pledge, Participation, & Collective Impact Agreement</h1>
      <p class="text-lg opacity-90">HINGECRAFT GLOBAL, INC.</p>
      <p class="text-sm opacity-75 mt-2">Converts Passive Users → Active Movement Participants</p>
    </div>
  </section>
